import pandas as pd
import utils.connpd as connpd

import utils.connpp as connpp

#definition of queries:
queryFSales = """

SET DATEFIRST 7;		-- Sunday because we need to push the Exchange Rate date (EX.EFT) to the next Saturday
...
df_FSales = connpd.execute_query(queryFSales)
